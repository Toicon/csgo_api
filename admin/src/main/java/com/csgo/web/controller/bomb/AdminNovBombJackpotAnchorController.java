 ...
 */
@RestController
@RequestMapping("/nov-bomb/anchor-jackpot")
@RequiredArgsConstructor
public class AdminNovBombJackpotAnchorController extends BackOfficeController {

    private final NovBombJackpotService novBombJackpotService;
    private final SystemJackpotService systemJackpotService;

    private static final SystemJackpotTypeEnums ANCHOR_JACKPOT_TYPE = SystemJackpotTypeEnums.NOV_BOMB_ANCHOR;
    ...
    public Result pageList(@RequestParam(defaultValue = "1") Integer pageNum,
        ...
        PageInfo<NovBombJackpotBillRecordDO> page = novBombJackpotService.pageList(ANCHOR_JACKPOT_TYPE, pageNum, pageSize);
