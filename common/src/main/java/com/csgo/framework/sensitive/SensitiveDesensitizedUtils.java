 ...
 * @author admin
 */
public class SensitiveDesensitizedUtils {
    ...
    /**
     * 【身份证号】显示前六位，四位，其他隐藏。共计18位或者15，比如：123456******2321
     *
     * @param id 身份证号码
     * @return 结果
     */
    ...
    /**
     * 【银行卡号】前六位，后四位，其他用星号隐藏每位1个星号，比如：348925**********6552
     *
     * @param cardNum 银行卡号
     * @return 结果
     */
    ...
    /**
     * 【密钥】密钥除了最后三位，全部都用*代替，比如：***sfc 脱敏后长度为6，如果明文长度不足三位，则按实际长度显示，剩余位置补*
     *
     * @param key 密钥
     * @return 结果
     */
