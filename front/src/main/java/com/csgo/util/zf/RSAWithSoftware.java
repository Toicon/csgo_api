...
public class RSAWithSoftware {
    ...
    public static String encryptByPublicKey(String data, String publicKey) throws Exception {
        ...
        out.close();
        return Base64.toBase64String(encryptedData).replaceAll("\n", "").replaceAll("\r\n", "");
    }
    ...
    public static String signByPrivateKey(String data, String privateKey) throws Exception {
        ...
        return Base64.toBase64String(signature.sign()).replaceAll("\n", "").replaceAll("\r\n", "");
    }
    ...
    public static String getPrivateKey(Map<String, Object> keyMap) throws Exception {
        ...
        return Base64.toBase64String(key.getEncoded()).replaceAll("\r\n", "").replaceAll("\r", "").replaceAll("\n", "");
    }
