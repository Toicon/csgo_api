...
public class UserResponse {
    ...
    private InvitedUserResponse invitedUser;
    @ApiModelProperty(value = "是否能填写邀请码  0 否  1是")
    private boolean canInviteCode;
    @ApiModelProperty(value = "填写邀请码倒计时（单位秒）")
    private int countDown;
    @ApiModelProperty(value = "是否打开内充")
    private boolean rechargeOpen;
    ...
    @ApiModelProperty(value = "是否打开来一发")
    private boolean LYFOpen;
}
