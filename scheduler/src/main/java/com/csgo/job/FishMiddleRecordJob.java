...
@Service
@Slf4j
public class FishMiddleRecordJob extends Job {
    ...
    protected void execute() throws Throwable {
        log.info("开始执行定时钓鱼作业--中级场");
        String lockKey = "LOCK:FISHJOB:" + FishSessionTypeEnum.MIDDLE.getCode();
        RLock rLock = null;
        try {
            ...
            if (rLock == null) {
                ...
                List<FishUserActivityHook> fishUserActivityHookList = fishJobService.getActivityHookList(FishSessionTypeEnum.MIDDLE.getCode());
