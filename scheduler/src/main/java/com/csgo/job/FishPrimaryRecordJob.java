...
@Service
@Slf4j
public class FishPrimaryRecordJob extends Job {
    ...
    protected void execute() throws Throwable {
        log.info("开始执行定时钓鱼作业--初级场");
        String lockKey = "LOCK:FISHJOB:" + FishSessionTypeEnum.PRIMARY.getCode();
        RLock rLock = null;
        try {
            ...
            if (rLock == null) {
                ...
                List<FishUserActivityHook> fishUserActivityHookList = fishJobService.getActivityHookList(FishSessionTypeEnum.PRIMARY.getCode());
